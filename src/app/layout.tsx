  ...
  return (
    <html lang="pl">
      <body className="bg-steam-dark text-steam-text min-h-screen flex flex-col antialiased selection:bg-steam-blue selection:text-steam-dark">
        ...
        <footer className="border-t border-steam-border/40 bg-steam-base/60 py-6 text-center text-xs text-steam-textMuted">
          <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p>Steam Family Picker &copy; {new Date().getFullYear()} &bull; Projekt społecznościowy</p>
            <p className="text-[11px]">Działa w oparciu o oficjalne Steam Web API i Steam OpenID 2.0</p>
          </div>
        </footer>
      </body>
    </html>
